...
> **Amendment 2026-08-27 (second)**: the detail panel and its spring slide (§3, §5 results, §6 moment 3) are superseded by [`2026-08-27-console-drawer-dark-mode.md`](2026-08-27-console-drawer-dark-mode.md) — tool info and run results move to a bottom console drawer inside the server boundary; the same spec adds the dark-mode variant (light-first stands, §2's "future variant" arrives).

...
| 2026-08-29 | Reading pass: one 780px measure across the workspace, markdown type cut to four voices, JetBrains Mono pinned, `<details>` HTML dropped, instructions clamp, Inter + prism "b" + favicon (PR #5) | pending | Row added at PR time; fill in the run id and live verification after merge |

...
| 2026-08-29 | Visual system tightening (type/space scale, single-column results, landing priority) + markdown detection and rendering (PR #4) | pending | Row written with the PR; set the status and run id once Actions completes on merge |
